 // Contoh data pohon dengan kategori
        const trees = [
            ...
            },
            {
                ...
                gambarPohon: 'https://placehold.co/600x800/699e69/fff?text=Pohon+Talas',
                gambarDaun: 'https://placehold.co/400x400/a2d699/fff?text=Daun+Talas',
                gambarAkar: 'https://placehold.co/400x400/3d5a80/fff?text=Akar+Serabut',
                deskripsi: {
                    bentukDaun: 'Perisai',
                    ujungDaun: 'Membulat',
            ...
            },
            {
                ...
                kategori: 'Buah',
                gambarPohon: 'https://placehold.co/600x800/d8f0d8/fff?text=Pohon+Kersen',
                gambarDaun: 'https://placehold.co/400x400/a2d699/fff?text=Daun+Kersen',
                gambarAkar: 'https://placehold.co/400x400/699e69/fff?text=Akar+Tunggang',
                deskripsi: {
                    bentukDaun: 'Oval',
                    ujungDaun: 'Meruncing',
            ...
            },
            {
                ...
                kategori: 'Buah',
                gambarPohon: 'https://placehold.co/600x800/773D2F/FFFFFF?text=Pohon+Nangka',
                gambarDaun: 'https://placehold.co/400x400/D4A373/3D405B?text=Daun+Nangka',
                gambarAkar: 'https://placehold.co/400x400/F1FAEE/A4C3B2?text=Akar+Tunggang',
                deskripsi: {
                    bentukDaun: 'Oblong',
            ...
            },
            {
                ...
                kategori: 'Palma',
                gambarPohon: 'https://placehold.co/600x800/98c1d9/293241?text=Pohon+Salak',
                gambarDaun: 'https://placehold.co/400x400/3d5a80/fff?text=Daun+Salak',
                gambarAkar: 'https://placehold.co/400x400/e0fbfc/293241?text=Akar+Serabut',
                deskripsi: {
            ...
            },
            {
                ...
                kategori: 'Palma',
                gambarPohon: 'https://placehold.co/600x800/d98a26/fff?text=Pohon+Kelapa',
                gambarDaun: 'https://placehold.co/400x400/f9a826/fff?text=Daun+Kelapa',
                gambarAkar: 'https://placehold.co/400x400/e0fbfc/293241?text=Akar+Serabut',
                deskripsi: {
                    bentukDaun: 'Menyirip',
                    ujungDaun: 'Meruncing',
            ...
            },
            {
                ...
                kategori: 'Palma',
                gambarPohon: 'https://placehold.co/600x800/8d8b67/fff?text=Pohon+Pinang',
                gambarDaun: 'https://placehold.co/400x400/c7d3a0/fff?text=Daun+Pinang',
                gambarAkar: 'https://placehold.co/400x400/8d8b67/fff?text=Akar+Serabut',
                deskripsi: {
                    bentukDaun: 'Majemuk menyirip',
                    ujungDaun: 'Meruncing',
                    pangkalDaun: 'Melebar',
            ...
            },
            {
                ...
                kategori: 'Buah',
                gambarPohon: 'https://placehold.co/600x800/9b9f87/fff?text=Pohon+Kelengkeng',
                gambarDaun: 'https://placehold.co/400x400/c7d3a0/fff?text=Daun+Kelengkeng',
                gambarAkar: 'https://placehold.co/400x400/8d8b67/fff?text=Akar+Tunggang',
                deskripsi: {
                    bentukDaun: 'Lanset',
                    ujungDaun: 'Meruncing (acuminatus)',
            ...
            },
            {
                ...
                kategori: 'Buah',
                gambarPohon: 'https://placehold.co/600x800/fec89a/fff?text=Pohon+Leci',
                gambarDaun: 'https://placehold.co/400x400/f9a826/fff?text=Daun+Leci',
                gambarAkar: 'https://placehold.co/400x400/d98a26/fff?text=Akar+Tunggang',
                deskripsi: {
                    bentukDaun: 'Majemuk menyirip',
                    ujungDaun: 'Meruncing (acuminatus)',
                    pangkalDaun: 'Membulat',
